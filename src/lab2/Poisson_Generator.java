...
public class Poisson_Generator extends Node {
	...
	public Poisson_Generator(int network, int node) {
		super(network, node);
		this.timeLogger = new TimeLogger();
	}
	
	public void StartSending(int network, int node, int timeLimit, double lambda)
	{
		this.lambda = lambda;
